    ...
    <div class="pc-container">
      ...
      ch.toUpperCase()
        ...
        <div class="card_back">
          ...
          style="background: linear-gradient(to right, ${colors[pokemonTypes[0]]
          ...
          <div class="poke-stats-name">Special-Attack: ${el.stats[3].base_stat
      }</div>
          <div class="poke-stats-bar"
          style="background: linear-gradient(to right, ${colors[pokemonTypes[0]]
          ...
          <div class="poke-stats-name">Special-Defense: ${el.stats[4].base_stat
      }</div>
          <div class="poke-stats-bar"
          style="background: linear-gradient(to right, ${colors[pokemonTypes[0]]
